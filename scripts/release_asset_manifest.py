...
def release_asset_paths(root: Path) -> set[Path]:
    ...
    _add_existing(assets, root, asset_root / "boss_keys" / "forest_villa.png")
    _add_existing(assets, root, asset_root / "boss_keys" / "efaunts_tomb.png")
    _add_existing(assets, root, asset_root / "boss_keys" / "chizoars_cavern.png")
    _add_existing(assets, root, asset_root / "boss_keys" / "trolls_enclave.png")
    _add_existing(assets, root, asset_root / "boss_keys" / "kruks_volcano.png")
    ...
    for path in _iter_matching_assets(asset_root / "statue", "*.png"):
        assets.add(path.relative_to(root))
